...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-4">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home.index') }}">Театр</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link active" href="{{ route('role.index') }}">Роли</a>
                    <a class="nav-link active" href="{{ route('spectacle.index') }}">Спектакли</a>
